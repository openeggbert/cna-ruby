...
Consumable now: 0. Dependency-complete but blocked: 5.
...
| Type | Kind | Ruby identities | Detail |
| --- | --- | --- | --- |
| `Microsoft.Xna.Framework.Graphics.DirectionalLight` | class | 5 | native: .ctor, set_DiffuseColor, set_Direction, set_Enabled; IL to derive: .ctor |
| `Microsoft.Xna.Framework.Graphics.EffectMaterial` | class | 1 | native: .ctor; IL to derive: .ctor |
...
| `Microsoft.Xna.Framework.Graphics.ModelMeshPart` | class | 8 | native: Draw |
