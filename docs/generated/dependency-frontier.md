...
Consumable now: 0. Dependency-complete but blocked: 9.
...
| Type | Kind | Ruby identities | Detail |
| --- | --- | --- | --- |
| `Microsoft.Xna.Framework.Graphics.BlendState` | class | 18 | native: Apply; IL to derive: .ctor, Dispose |
| `Microsoft.Xna.Framework.Graphics.DepthStencilState` | class | 21 | native: Apply; IL to derive: .ctor, Dispose |
...
| `Microsoft.Xna.Framework.Graphics.RasterizerState` | class | 11 | native: Apply; IL to derive: .ctor, Dispose |
| `Microsoft.Xna.Framework.Graphics.SamplerState` | class | 15 | native: Apply; IL to derive: .ctor, Dispose |
...
| Type | Kind | Ruby identities | Detail |
| --- | --- | --- | --- |
| `Microsoft.Xna.Framework.Graphics.VertexDeclaration` | class | 5 | native: Bind, Unbind; IL to derive: .ctor, GetVertexElements, Dispose |
