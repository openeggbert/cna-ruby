...
Consumable now: 0. Dependency-complete but blocked: 8.
...
| --- | --- | --- | --- |
| `Microsoft.Xna.Framework.Content.ResourceContentManager` | class | 2 | unmapped BCL: System.Resources.ResourceManager; IL to derive: .ctor, OpenStream |
...
## BCL_PROJECTION + NATIVE_RUNTIME (2)

| Type | Kind | Ruby identities | Detail |
| --- | --- | --- | --- |
| `Microsoft.Xna.Framework.Audio.WaveBank` | class | 9 | events: Disposing; unmapped BCL: System.Int16; native: .ctor, Dispose, Finalize, get_IsInUse; IL to derive: .ctor, Finalize, Dispose |
