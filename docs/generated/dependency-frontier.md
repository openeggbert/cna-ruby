...
Consumable now: 1. Dependency-complete but blocked: 20.
...
| --- | --- | --- | --- |
| `Microsoft.Xna.Framework.Input.Touch.TouchPanel` | class | 9 | IL to derive: GetCapabilities, ReadGesture, GetState |
