...
Consumable now: 0. Dependency-complete but blocked: 6.
...
| `Microsoft.Xna.Framework.Graphics.SamplerStateCollection` | class | 1 | native: InitializeDeviceState, set_Item |
