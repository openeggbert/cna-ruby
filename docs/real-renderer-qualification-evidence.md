...
1527 runs / 0 failures / 0 errors under each of the three artifacts at Foundation 82 — 50155
assertions and 21 skips on `HEADLESS`, 50169 and 17 on `OPENGL33`, 50255 and **none** on the
...
rake test                                        # 1527 runs, 0 failures, 17 skips on this artifact
```
