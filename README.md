...
- `docs/game-timing-properties-evidence.md` — Foundation 42, Game's four timing and presentation properties: why they are managed state, the two constructor defaults a summary would round wrong, and the op_LessThan/op_LessThanOrEqual split that makes one TimeSpan accept zero and the other refuse it
