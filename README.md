...
- the general BCL projection register `CNA::Runtime::BclProjection`, including the rule that a CLR exception base projects to a Ruby exception superclass rooted at `StandardError` rather than `Object`
