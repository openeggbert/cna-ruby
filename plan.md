...
The strict surface is now 77 types / 1462 Ruby member identities. `GraphicsProfile` is locally strict-zero. The seven pre-existing partial native/runtime types and all 135 missing members remain unchanged.
