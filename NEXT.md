...
## Game's remaining five

`Dispose(Boolean)`, `Finalize`, `ShowMissingRequirementMessage`, `Window`, `Content`. Foundation 44
took `Tick` off this list, Foundation 45 `IsActive` and Foundation 46 `LaunchParameters`.
