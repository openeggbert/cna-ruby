...
| count | what it measures |
| ---: | --- |
| 94 | strict diagnostics in total |
| 57 | `MISSING_TYPE` |
| 24 | `MISSING_MEMBER` |
| 13 | `OVERLOAD_MAPPING_MISMATCH` |
...
| count | what it measures |
| ---: | --- |
| 6 | members `GraphicsDevice` still owes |
